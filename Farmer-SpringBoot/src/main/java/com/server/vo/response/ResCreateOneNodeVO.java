...
public class ResCreateOneNodeVO {
    ...
    public ResCreateOneNodeVO() {
    }

    public ResCreateOneNodeVO(String isSuccess, ResErrorInfo errorInfo, String displayCopy, String nodePath) {
        this.isSuccess = isSuccess;
        this.errorInfo = errorInfo;
        this.displayCopy = displayCopy;
        this.nodePath = nodePath;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("ResCreateOneNodeVO{");

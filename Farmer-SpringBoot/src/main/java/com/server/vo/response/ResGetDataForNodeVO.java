...
public class ResGetDataForNodeVO {
    ...
    public ResGetDataForNodeVO() {
    }

    public ResGetDataForNodeVO(String isSuccess, ResErrorInfo errorInfo, String displayCopy, String nodePath, String data) {
        this.isSuccess = isSuccess;
        this.errorInfo = errorInfo;
        this.displayCopy = displayCopy;
        this.nodePath = nodePath;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("ResGetDataForNodeVO{");

    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tImage = '<img src="{data}" class="file-preview-image kv-preview-data" title="{caption}" ' +
                'alt="{caption}"' + tStyle + '>\n';
            //830行
            tText = '<textarea class="kv-preview-data file-preview-text" id="kv-preview-dataandfile-preview-text" title="{caption}" readonly' + tStyle + '>' +
                '{data}</textarea>\n';
